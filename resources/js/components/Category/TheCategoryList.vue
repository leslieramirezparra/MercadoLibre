                ...
                columns: [
                    { data: 'name', name: 'name', orderable: true, searchable: true },
                    {
                        ...
                        render: (data, type, row, meta) => {
                            return `<div class="id-flex justify-content-center" data-role='actions'>
                    ...
                    <button onclick='event.preventDefault();' data-id='${row.id}' role='delete' class="btn btn-danger btn-sm">
